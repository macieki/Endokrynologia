...
**NOTE: April Update, Zoom web client( Join via browser ) will not work at the moment due to maintenance from Zoom side. Refer to [Zoom Status Page](https://status.zoom.us/  "Zoom Status Page") for status updates > Web Client. Please refer to [this thread](https://wordpress.org/support/topic/embed-zoom-meeting "Zoom Status Page") for status update on Zoom join via browser functionality. Please disable join via browser option in your meetings for now ! Sorry for any inconvenience caused !**
