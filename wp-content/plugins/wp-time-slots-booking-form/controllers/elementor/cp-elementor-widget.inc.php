...
if (!class_exists('CP_WPTimeSlotsBK_Elementor'))
{    
    class CP_WPTimeSlotsBK_Elementor {
          
      private $prefix = 'cptslots';           
      ...
      function enqueue_frontend_styles() {
          ...
          wp_enqueue_script( $this->prefix.'_builder_script',
                 get_site_url( get_current_blog_id() ).'?cp_cptslotsb_resources=public&nc=1',array("jquery","jquery-ui-core","jquery-ui-datepicker","jquery-ui-widget","jquery-ui-position","jquery-ui-tooltip","query-stringify",$this->prefix."_validate_script"), false, true );          
      }      
...
$cp_cfte_elementor_widget = new CP_WPTimeSlotsBK_Elementor;
